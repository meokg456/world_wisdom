      ...
      child: Scaffold(
        ...
        body: isEditing
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                            ...
                            validator: (name) {
                              return name.length > 0 ? null : "Invalid name";
                            },
            ...
            : Container(
                ...
                child: authenticationModel.user == null
                    ? null
                        ...
                        child: Column(
                          children: [
                            ...
                            ListTile(
                              ...
                              subtitle: Text(
                                typeValues
                                    .reverse[authenticationModel.user.type],
                                textAlign: TextAlign.center,
                              ),
                            ),
                            Divider(),
                            Card(
                              child: ListTile(
                                ...
                                subtitle: Text(
                                    "Phone number: ${authenticationModel.user.phone}"),
                              ),
                            )
                          ],
                        ),
