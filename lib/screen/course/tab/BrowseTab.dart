      ...
      children: [
        ...
        Container(
          ...
          child: Stack(
              ...
              children: [
                Image.asset("resources/images/new-release.jpeg",
                  height: 100,
                  fit: BoxFit.fill,
        ...
        Container(
          ...
          child: Stack(
              ...
              fit: StackFit.passthrough,
              children: [
                Image.asset("resources/images/recommended.jpg",
                  height: 100,
                  fit: BoxFit.fill,
                  colorBlendMode: BlendMode.darken,
                  color: Color(0xA0000000),),
            ...
            children: [
              Container(
                ...
                child: Stack(
                    ...
                    fit: StackFit.passthrough,
                    children: [
                      Image.asset("resources/images/conferences.jpg",
                        height: 100,
                        fit: BoxFit.fill,
                        colorBlendMode: BlendMode.darken,
                        color: Color(0xA0000000),),
              ...
              Container(
                ...
                child: Stack(
                    ...
                    fit: StackFit.passthrough,
                    children: [
                      Image.asset("resources/images/generic.jpg",
                        height: 100,
                        fit: BoxFit.fill,
                        colorBlendMode: BlendMode.darken,
                        color: Color(0xA0000000),),
              ...
              Container(
                ...
                child: Stack(
                    ...
                    fit: StackFit.passthrough,
                    children: [
                      Image.asset("resources/images/software-development.jpg",
                        height: 100,
                        fit: BoxFit.fill,
                        colorBlendMode: BlendMode.darken,
                        color: Color(0xA0000000),
        ...
        Container(
            ...
            child: Text("Popular Skills", style: TextStyle(fontSize: 18),)),
        Container(
